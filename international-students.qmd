...
4)  **Strategy & Leadership** (often mid-career+)
...
> Some MSDM courses include **micro-internship experiences** where you work with a real client and complete paid, course-embedded projects.

**Important note for international students (CPT timing):**

> When a micro-internship is required as part of a course, exceptions may apply regarding typical CPT timing — always confirm details with the program and the international student office.
...
These deadlines are absolute the last day the university would accept application. This, however, doesn't guarantee that you will have sufficient time for securing Visa at your country. **You should factor your home country situation in when you make application decisions**.
:::

## **Admission Decision Timeline & Implications**

From the moment you submitted your application, it may take anywhere between 7 weeks to 13 weeks to hear about admissions decision. For details about Step 1 - Step 4, see [Decision Timeline](admission.qmd#decision-timeline).
...
If this step takes, say, three months and your goal is to get Visa two months prior to the start of Fall semester (August 20), you need to apply for Visa about March 20. Considering that you need 11 weeks - 17 weeks from admission application to reception of I-20, you need to submit application three to four months prior to applying for Visa. This means that you need to apply **November 20 or December 20**.
:::
...
If you are from country, where it takes long time to set up a Visa interview, you would be better off by applying for the MSDM and get admitted early to secure sufficient time. I have seen students from a certain reigions (e.g., South Asian countries) unable to get Visa before August when fall semester starts even if they were admitted early. You should submit probably one or two months prior to the deadline (May 1).
