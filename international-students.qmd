...
## STEM designation + OPT: what it helps (and what it doesn’t)
...
## Career strategy: pick role lanes that are more sponsorship-aligned
...
#### 1) Marketing Data & Analytics roles (typically the strongest alignment)
...
#### 2) Technical & Performance roles (best when they’re truly technical)
...
#### Strategy & Leadership (usually not immediate post-grad)

These roles are often reached after experience in the other lanes, so they are not for rookies.

## How CPP MSDM supports these paths (curriculum options + tools)

### 3 Elective Options (you choose based on target career roles)
...
## Real Experience while You Study: Micro-internships + On-campus Jobs
...
## Scholarships + Assistantships (what to expect)
...
-   TA or RA are not awarded as part of the admissions process, and they are not guaranteed for all students. They are typically awarded based on a combination of factors, including academic performance, relevant experience, and the needs of the department. You can only apply for these positions after you have enrolled in courses and have access to Handshake.

    -   This is why you should apply early if you are interested in these opportunities, so you can plan accordingly.

## “Right fit” checklist (who tends to thrive here)
