...
| **Year 1 – Spring** | [**IBM 6510**]{.msdm-course-code} **– Foundations of Customer Analytics** | Core | Data Analysis, Statistical Inference, Regressoin analysis and assumptions,  Dealing with violations of assumptions | R, RStudio/Positron, gtsummary, GitHub, Project |
...
|  | [**IBM 6520**]{.msdm-course-code} **– Market Forecasting** | Elective | Predictive Modeling, Forecasting, Time Series | R (forecast, prophet), Conjoint analysis, RStudio/Positron, Excel, GitHub, Project |
...
|  | [**IBM 6540**]{.msdm-course-code} **– Applied Machine Learning in Marketing** | Elective | Causal Machine Learning, ML Apps, Model Building, Evaluation, Factory analysis, Latent variable models, mediation/moderation | R (caret, tidymodels), lavaan, Python (scikit-learn, TensorFlow), RStudio/Positron, GitHub, Project |
|  | [**IBM 6600**]{.msdm-course-code} **– Marketing Text Analytics with LLMs & AI** | Elective | Social listening, Sentiment analysis, Optimize campaign, Topic modeling, NLP, Text Mining, Generative AI |  R (Tidytext), RStudio/Positron, Python (transformers, spaCy), LLM/ChatGPT APIs, GitHub, Project |
...
|  | [**IBM 6500**]{.msdm-course-code} **– Customer Insights Methods & Survey Research** | Core | Survey Design, Data Collection, Quant Research | Qualtrics, SPSS, R, RStudio/Positron, Zotero, Project |
...
|  | [**IBM 6530**]{.msdm-course-code} **– Marketing Analytics** | Elective | Data Integration, Dashboarding, KPI Reporting, Various marketing models with various types of data, Marketing automation | GA4, GTM, BigQuery, Looker Studio, R, RStudio/Positron, Shiny App, Quarto website, Attribution modeling, Project |
...
|  | [**IBM 6700**]{.msdm-course-code} **– Marketing Data Management** | Elective | Data Architecture, ETL, Governance | R/Python, RStudio/Positron, SQL, BigQuery, Data Warehouse Tools (e.g., Databricks, snowflake), Project |
:::
