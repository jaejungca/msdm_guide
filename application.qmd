...
Only if you passed Step 1, then your package will be forwarded to the MSDM Office. The MSDM Office uses spreadsheet to summarize objective facts about each applicant – name, major, univerisity, graduation year, GPA, English test score (for international students only), courses taken for Math, Statistics, certificates, job experience, career aspiration, etc. We do not make decisions using GPA alone. Instead, we make decisions holistically. See below "How We Evaluate Applications."

Once the decision is made, MSDM office notifies the Admissions Office.

1.  It will report back to the Admissions Office electronically on PolyDoc system.
...
This means that Step 3 and Step 4 happens almost the same time and about a week after Step 2.
