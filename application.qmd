...
-   **Electives: 14 units (3 Options):**
    ...
    You can choose electives for either
...
This is an **onsite** program (you must be able to commute), but it uses a **hybrid class modality** where up to **50% of class time may be virtual**. For example, in a 15-week semester, a course could meet 8 weeks in person and 7 weeks on Zoom.
...
Students outside California pay the **same per-unit tuition** in this program structure as California residents.
:::
