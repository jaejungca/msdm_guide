...
A strong statement also communicates **career direction and fit**: what area(s) of digital marketing or marketing analytics they are most interested in (e.g., Content/Creative roles, Techonogy/Performance roles, or Marketing Data/Analytics roles), what they hope to learn, and how the program connects to their short-term and long-term goals (Refer to [**Target Digital Marketing Career Roles**](#target-digital-marketing-career-roles) section). Applicants are encouraged to include **specific examples** that demonstrate curiosity, initiative, and impact—such as solving a problem with data, creating or evaluating a campaign, or using insights to guide decisions. If you are an international student, refer to [**Career Strategy**](international-students.qmd#career-strategy) section of [International Student Guidance](international-students.qmd) page to learn about the factors you want to consider in determining your career direction.

Finally, strong statement should highlight what the applicant will **contribute** to the program community, such as technical skills, creative strengths, leadership, collaboration, or unique perspectives shaped by their experiences.
...
## **Admission Decision Process, Method, and Timeline** {#admission-decision-process-method-timeline}

### Decision Process

When you submit your application package at Cal State Apply, evaluation is done in **Two-step process**.

**Step 1: The Office of Admission will screen your package to ensure two things.**

-   Do you have 4-year Bachelor's Degree?

-   Do you have at least 2.5 GPA?

Once you meet the basic screening criteria, they will forward it to the program office for final decision.

**Step 2: The MSDM Program Office will evaluate the entire application package and make a final decision.**

Only if you passed Step 1, then your package will be forwarded to the MSDM Office. The MSDM Office uses spreadsheet to summarize objective facts about each applicant – name, major, univerisity, graduation year, GPA, English test score (for international students only), courses taken for Math, Statistics, certificates, job experience, career aspiration, etc.

> We do not make decisions using GPA alone. Instead, we make decisions holistically. See below "**Decision Methods:** **How We Evaluate Applications**."
>
> Once the decision is made, MSDM office notifies the Admissions Office will notify the Admissions Office electronically on **PolyDoc system**.

**Step 3: The Admissions Office will post admission decisions (accepted/rejected) on Cal State Apply about one week after the MSDM Program Office notifies them of the decision via PolyDoc system.**

**Step 4: The MSDM Office will send you a letter of acceptance as soon as the Admissions Office post the decisions on Cal State Apply**.

This means that Step 3 and Step 4 happens almost the same time about a week after Step 2.

### Decision Methods: How We Evaluate Applications
...
From the moment you submitted your application, it may take anywhere between 7 weeks to 13 weeks to hear about admissions decision.

1.  **Step 1**: 4 weeks - 8 weeks

2.  **Step 2**: 2 weeks - 4 weeks

3.  **Step 3** **and Step 4**: 1 week

::: {.callout-warning title="International Students Only"}
International students must add at least one month for I-20, a document needed to apply for Visa. For further information, go to [Timeline for International Students](international-students.qmd#admission-decision-timeline-implications).
:::
...
-   **MSDM Mentor/Ambassador**
    ...
    ::::::: {.callout-note appearance="minimal" style="border-left: 14px solid #F9C80E;     border-radius: 14px;     padding-left: 1rem;     box-shadow: 0 6px 18px rgba(0,0,0,.08);     background:         linear-gradient(90deg, rgba(0,88,38,.18) 0 4px, transparent 4px) ,         linear-gradient(180deg, rgba(249,200,14,.10), rgba(255,255,255,1));"}
    ::: {.fs-4 .fw-bold}
    {{< fa user-tie >}} Hana Mai
    :::

    *MSDM Ambassador*, Current Student, MSDM Candidate\
    ...
    **Virtual:** [Join Zoom Session](https://cpp.zoom.us/my/hnmai)
    :::
...
-   **Program & curriculum questions:**
    ...
    ::::::: {.callout-note appearance="minimal" style="border-left: 14px solid #568203;     border-radius: 14px;     padding-left: 1rem;     box-shadow: 0 6px 18px rgba(0,0,0,.08);     background:         linear-gradient(90deg, rgba(0,88,38,.18) 0 4px, transparent 4px) ,         linear-gradient(180deg, rgba(249,200,14,.10), rgba(255,255,255,1));"}
    ::: {.fs-4 .fw-bold}
    {{< fa user-tie >}} Dr. Jae Jung
    :::

    *MSDM Program Director*, *Director of CCIDM*, Singelyn Graduate School of Business, College of Business Administration\
    [Linkedin](https://www.linkedin.com/in/jaeminjung/) \| [Email](mailto:jmjung@cpp.edu) \| [Short Bio](https://www.cpp.edu/faculty/jmjung/index.shtml)
    ...
    **Virtual:** Join Zoom Session ([Appointment only via Calendly](https://calendly.com/jmjung/15min))
    :::
...
-   **Registration/tuition/services:**
    ...
    ::::::: {.callout-note appearance="minimal" style="border-left: 14px solid #F33A6A;     border-radius: 14px;     padding-left: 1rem;     box-shadow: 0 6px 18px rgba(0,0,0,.08);     background:         linear-gradient(90deg, rgba(0,88,38,.18) 0 4px, transparent 4px) ,         linear-gradient(180deg, rgba(249,200,14,.10), rgba(255,255,255,1));"}
    ::: {.fs-4 .fw-bold}
    {{< fa user-tie >}} Ashley Cartwright
    :::

    *Sr. Program Manager*, College of Professional and Global Education\
    [Linkedin](https://www.linkedin.com/in/ashley-cartwright-mpa-4969b261/) \| [Email](mailto:arcartwright@cpp.edu)
