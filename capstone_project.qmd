...
format: 
  html:
    ...
    fontsize: 18px
    metadata:
      description-meta: "This page provides students with valuable insights on the capstone project before and during the year-long culminating experience process."
    other-links: 
...
[Introduction]{style="color: #FF007F; font-weight: bold; font-size: 30px;"}
